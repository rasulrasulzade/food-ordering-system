    ...
    public void receive(@Payload List<RestaurantApprovalResponseAvroModel> messages,
        ...
        messages.forEach(restaurantApprovalResponseAvroModel -> {
            try {
                ...
                //NO-OP for optimistic lock. This means another thread finished work, do not throw error to prevent reading the data from kafka again!
                log.info("Caught optimistic locking exception in RestaurantApprovalResponseKafkaListener for order id: {}", restaurantApprovalResponseAvroModel.getOrderId());
            } catch (OrderNotFoundException e){
                //NO-OP for OrderNotFoundException
                log.info("No order found for order id: {}", restaurantApprovalResponseAvroModel.getOrderId());
            }
        });
    }
}
