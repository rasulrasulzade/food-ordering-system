...
public class ApprovalOutboxHelper {
    ...
    @Transactional(readOnly = true)
    public Optional<OrderApprovalOutboxMessage> getApprovalOutboxSagaMessageBySagaIdAndSagaStatus(UUID sagaId, SagaStatus... sagaStatus) {
    ...
    private String createPayload(OrderApprovalEventPayload orderApprovalEventPayload) {
        try {
            ...
            log.info("Could not create OrderApprovalEventPayload for order id: {}",
