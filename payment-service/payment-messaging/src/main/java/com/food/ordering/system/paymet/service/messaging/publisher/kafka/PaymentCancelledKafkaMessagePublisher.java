package com.food.ordering.system.paymet.service.messaging.publisher.kafka;
...
import com.food.ordering.system.paymet.service.messaging.mapper.PaymentMessagingDataMapper;
...
public class PaymentCancelledKafkaMessagePublisher implements PaymentCancelledMessagePublisher {
    ...
    public void publish(PaymentCancelledEvent domainEvent) {
        ...
        try {
            ...
            log.info("Error while sending PaymentResponseAvroModel message to kafka for order id: {}, error: {}", orderId, e.getMessage());
